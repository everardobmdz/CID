...
<main>
    ...
    <nav class="navbar navbar-custom navbar-light navbar-fixed-top one-page" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand p-0" href="https://www.udg.mx"><img class="img-fluid" src="../public/images/logoUDG.jpg" width="212" height="auto"></a>
            </div>
            <div class="collapse navbar-collapse" id="custom-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#totop">Inicio</a></li>
                    <li><a class="section-scroll" href="#services">Quiénes somos</a></li>
                    <li><a class="section-scroll" href="#works">Investigadores</a></li>
                    <li><a class="section-scroll" href="#team">Publicaciones</a></li>
                    <li><a class="section-scroll" href="#news">Divulgación</a></li>
                    <li><a class="section-scroll" href="#pricing">Eventos</a></li>
    ...
    <div class="main">
                                ...
                                <div class="row">
                                    <div class="extension-element col-md-6 col-lg-3">
                                        <div class="extension-container bg-extension2">
                                            <h4>El DESMOS, conjuntamente con el Observatorio de Movimientos Sociales-Observamos, realiza un Seminario Permanente: Movimientos Sociales, Acción Colectiva y Política.</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="extension-element col-md-6 col-lg-3">
                                        <a target="_blank" href="http://www.cucsh.udg.mx/cmarti/historia" class="extension-container bg-extension1">
                                            ...
                                            <h4>El DESMOS es sede de la Cátedra José Martí.</h4>
                                        </a>
                                    </div>
                                    ...
                                    <div class="extension-element col-md-6 col-lg-3">
                                        <a class="extension-container bg-extension1" target="_blank" href="https://docs.google.com/spreadsheets/d/1o7Vxh-cxY4rxOdvI1LlxYNVhD1T3I9Kq/edit?usp=sharing&ouid=111295052311343092029&rtpof=true&sd=true">
                                            ...
                                            <h4>El DESMOS cuenta con un Centro Documental Especializado en sus intalaciones (Biblioteca).</h4>
                                        </a>
        ...
        <div class="module-small bg-dark-25">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="widget">
